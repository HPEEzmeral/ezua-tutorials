...
labels = ['apple', 'banana', 'beetroot', 'bell pepper', 'cabbage', 'capsicum',
          ...
          'garden hose', 'garlic', 'ginger', 'grapes', 'hammer', 'ice remover spray',
          'jalepeno', 'kiwi', 'lemon', 'lettuce', 'mango', 'masking tape', 'meter', 'onion',
          'orange', 'paint', 'paintbrush', 'paprika', 'pear', 'peas', 'pineapple', 'pomegranate',
          'potato', 'raddish', 'soy bean', 'spinach', 'square board', 'steel nail', 'sweetcorn',
...
# ADAPT Set up ezPresto connection credentials
...
def query_presto(product):
    ...
    #ADAPT query if you named DB or schema differently

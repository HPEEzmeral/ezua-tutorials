...
# S3_ENDPOINT_URL = 'https://home.hpe-dev-ezaf.com:31900'
...
LOCAL_FILE_PATH = 'FruitModelSmall.h5'
...
if os.path.exists(LOCAL_FILE_PATH):
    ...
    model = keras.models.load_model('end2end.h5')


# Define the class labels
classes = ['apple', 'banana', 'cucumber', 'ezmeral coupon', 'orange']
...
def app():
    ...
    if take_photo is not None:
        ...
        if prediction != 'ezmeral coupon':
            ...
            st.metric(label="EZSQL Query (Presto)", value='SELECT price FROM fruits WHERE fruit = "' + prediction + '"')

...
gbm_model.write().overwrite().save('file:///mounts/hpedemo-user01-volume/pf-spark-windturbine/GBM.model')

from pyspark.ml.regression import GBTRegressionModel
gbm_model_dtap = GBTRegressionModel.load("file:///mounts/hpedemo-user01-volume/pf-spark-windturbine/GBM.model")
